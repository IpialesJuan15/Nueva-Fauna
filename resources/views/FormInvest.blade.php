...
<head>
    ...
    <link rel="stylesheet" href="../../public/css/formInvest.css">
...
<body>
    ...
    <main>
            ...
            <form id="form-registro" class="registro-form">
                ...
                <div class="registro-contenedor">
                    ...
                    <div class="registro-derecha">
                        ...
                        <input type="number" id="latitud" step="0.000001" placeholder="Ejemplo: -12.0464" required>
                        <label for="longitud">Longitud:</label>
                        <input type="number" id="longitud" step="0.000001" placeholder="Ejemplo: -77.0428" required>
        ...
        <section id="editar" class="content" style="display:none;">
            ...
            <form id="form-editar">
                ...
                <input type="text" id="editar_nombre_comun">
                <label for="editar_reino">Nuevo Reino:</label>
                <input type="text" id="editar_reino">
                <label for="editar_familia">Nueva Familia:</label>
                <input type="text" id="editar_familia">
                <label for="editar_genero">Nuevo Género:</label>
                <input type="text" id="editar_genero">
                <label for="editar_nombre_cientifico">Nuevo Nombre Científico:</label>
                <input type="text" id="editar_nombre_cientifico">
                <label for="observacion">Observación:</label>
                <textarea id="observacion" placeholder="Razón de la modificación..." required></textarea>
    ...
    <script src="../../public/js/formInvest.js"></script>
