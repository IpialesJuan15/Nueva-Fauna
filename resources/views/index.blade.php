...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="../../public/css/templatemo-eduwell-style.css">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 offset-lg-3">
          <div class="section-heading">
            <h4>Aves endémicas de <em>Ibarra</em></h4>
            <p>La ciudad blanca cuenta con varias aves endémicas, de las cuales destacaremos las siguientes</p>
          </div>
        </div>
        <div class="col-lg-12">
          <div class="naccs">
            <div class="tabs">
              <div class="row">
                <div class="col-lg-3">
                  <div class="menu">
                    <div class="active gradient-border"><span>Tórtola Orejuda</span></div>
                    <div class="gradient-border"><span>Pájaro Brujo</span></div>
                    <div class="gradient-border"><span>Golondrina Albiazul </span></div>
                    <div class="gradient-border"><span>Gorrión Ruficollarejo</span></div>
                  </div>
                </div>
                <div class="col-lg-9">
                  <ul class="nacc">
                    ...
                    <li>
                      <div>
                        <div class="left-image">
                          <img src="../../public/images/brujo.png" alt="">
                    ...
                    <li>
                      <div>
                        <div class="left-image">
                          <img src="../../public/images/albiazul.png" alt="">
                    ...
                    <li>
                      <div>
                        <div class="left-image">
                          <img src="../../public/images/ruficollarejo.png" alt="">
